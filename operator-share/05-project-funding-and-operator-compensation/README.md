# Project funding & operator compensation - findings archive

**Product:** Ascendant EQ community funding (Server Support, Ko-fi, runway API)  
**Assessment date:** 2026-06-13 (public materials); Ko-fi observations through 2026-06-16  
**Scope:** Whether contributors can understand **how donated funds may be allocated** - categories, reserves, capital vs operating costs, and compensation policy

This is **not** a misconduct investigation. Reserves, development time, and steward labor are **legitimate** project expenses when disclosed.

Donation **receipt totals**, Ko-fi feed behavior, trust hub, and informed-consent UX live in **[03-transparency-and-accountability](../03-transparency-and-accountability/README.md)** (DT-xxx, KF-xxx).
...
[operator-response.md](../operator-response.md) (funding section) · [private-operator-summary.md](private-operator-summary.md)

---

## Out of scope

- **Ko-fi feed visibility, perks policy, acknowledgement UX** - [03-transparency-and-accountability](../03-transparency-and-accountability/README.md)
- **Login/hosting security exposure** - [01](../01-loginserver-brief/README.md), [02](../02-residential-host-brief/README.md)
- **Fraud, embezzlement, or criminal allegations**
- **Internal monitoring ledgers, DB exports, or investigator tooling**
- **Specific dollar estimates** unless operator publishes them

---

## Related findings in other briefs

| Topic | Brief | Finding |
|-------|-------|---------|
| Hosting topology vs donation copy | 03 | DT-001 |
| Runway burn buckets | 03 | DT-010 |
| Receipt / inflow totals | 03 | DT-011 |
| Runway formula provenance | 03 | DT-022 |
| Residential game hosting | 02 | RH-010, RH-011 |
